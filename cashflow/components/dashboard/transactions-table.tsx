      ...
      <div className="p-6">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <p className="font-medium text-sm text-white truncate">{tx.name}</p>
                    {tx.status && (
                      <span className={cn(
        ...
        {hasMore && (
          <button
            ...
            className="w-full mt-4 py-2 text-xs font-bold text-brand-primary hover:text-white transition-colors flex items-center justify-center gap-1"
          >
